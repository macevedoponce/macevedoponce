...
Complete **[Android course developed ]()** at the continental university, separated by weeks from 1 to 16, it also contains the partial exam that consists of developing a movie application using API Rest, a final exam that consists of developing a delivery application for a pharmacy.
...
Mediapp is an **[Android]()** App developed in the mobile solutions course at the continental university. It has functionalities for both the client, delivery person and owner to be able to upload the products. All the code generated by the mobile and web application can be found in my personal repository.
